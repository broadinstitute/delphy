...
TEST(Io_test, read_maple) {
  ...
  EXPECT_THAT(maple_file.tip_descs[0].t_min, testing::Eq(parse_iso_date("2024-07-31")));
  EXPECT_THAT(maple_file.tip_descs[0].t_max, testing::Eq(parse_iso_date("2024-07-31")));
  ...
  EXPECT_THAT(maple_file.tip_descs[1].name, testing::Eq("Seq2|2024-06"));
  EXPECT_THAT(maple_file.tip_descs[1].t_min, testing::Eq(parse_iso_date("2024-06-01")));
  EXPECT_THAT(maple_file.tip_descs[1].t_max, testing::Eq(parse_iso_date("2024-07-01")));
